 ...
 window.updatePesanan = async function(id) {
    try {

        const statusEl = document.getElementById('status');
        const bayarEl = document.getElementById('statusPembayaran');
        const catatanEl = document.getElementById('catatan');

        const data = {
            status: statusEl.value,
            statusPembayaran: bayarEl.value,
            catatan: catatanEl.value
        };

        await LaundryAPI.updatePesanan(id, data);
